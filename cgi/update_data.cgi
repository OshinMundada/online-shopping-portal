...
my $message = " ";
my $sql = $newdbh->prepare("UPDATE product SET catID = '$catID' ,venID = '$venID', vendorModel = '$vendorModel', description = '$description', features = '$features', cost='$cost' ,retail='$retail' ,image='$image' WHERE sku = '$sku'");
